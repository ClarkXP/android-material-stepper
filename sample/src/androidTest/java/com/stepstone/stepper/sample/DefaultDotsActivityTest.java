...
@LargeTest
public class DefaultDotsActivityTest {

    @Rule
    public WakeUpIntentsTestRule<DefaultDotsActivity> intentsTestRule = new WakeUpIntentsTestRule<>(DefaultDotsActivity.class);
